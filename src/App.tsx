      ...
      <div className={appSt.container}>
        ...
        {stocks.no.map(stock => {
          return (
            <PureCell
              onClick={() => {
                window.gtag('event', '7397_choose_security', { var: 'var3', security_ticker: stock.ticker });
            ...
            <div>
              <div className={appSt.answerRow}>
                <Button
                  ...
                  onClick={() => {
                    window.gtag('event', '7397_click_answer', { var: 'var3', answer: 'yes' });
                ...
                <Button
                  ...
                  onClick={() => {
                    window.gtag('event', '7397_click_answer', { var: 'var3', answer: 'no' });
